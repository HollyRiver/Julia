...
# ╔═╡ 55034910-eb4a-11ee-040b-f34c82e08b9b
using PlutoUI, Plots, Distributions, Random

# ╔═╡ 117364d3-fac4-446b-a1cd-9f4c9c5a4add
md"""
### 1. imports
"""

# ╔═╡ 6a56ae56-ef91-4314-80a7-09d3d0d6acda
Plots.plotly()

# ╔═╡ b0bc8caf-9295-4fa4-ad6a-5c9bdba96732
PlutoUI.TableOfContents()

# ╔═╡ a86363bb-0b31-4719-a4b5-f191bed7c637
md"""
### 2. HW
...
# ╔═╡ 9feea8de-96fd-4301-8216-8d0025bbb0db
md"""
 $\bar{X}$는 분산이 $10^2$, 평균이 $\mu$인 분포에서 추출한 크기가 25인 확률표본의 평균이다. 관찰된 표본의 평균이 $\bar{x} = 67.53$일 때 $\mu$에 대한 87%신뢰구간을 구하여라.
"""

# ╔═╡ 3365c78c-18ba-461f-9561-da78acc9e4d3
md"""
`-` 풀이

 $X \sim N(μ,10^2)$이므로 $\bar{X} \sim N(μ, \frac{10^2}{25})$이다.

따라서 $μ$에 대한 87% 신뢰구간은 아래와 같다.
"""

# ╔═╡ 42ea0c93-0fd3-48ec-9b88-caa93a12bd24
let
	x̄ = 67.53
	σₓ̄ = 10/sqrt(25)
	c = quantile(Normal(0, σₓ̄), 0.935)
	l, u = (x̄ - c, x̄ + c)
	print((l, u))
end
