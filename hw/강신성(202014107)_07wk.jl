...
# ╔═╡ 9e485090-fbf6-11ee-05d7-31278099d84f
using PlutoUI, Images

# ╔═╡ 6c78b6cf-67a1-4c64-b939-2841f2db2ba4
md"""
### 1. Imports
"""

# ╔═╡ 103a18b3-d6e9-4f2c-bfab-c2a3a75ddaf0
PlutoUI.TableOfContents()

# ╔═╡ a9bd2c8b-b929-45e9-bed5-06d7be9bc0f3
md"""
### 2. 제곱하니
"""

# ╔═╡ dc2a1fec-2e14-4e80-a312-d97f510cd2a0
hani = load(download("https://github.com/guebin/SC2022/blob/main/hani.jpeg?raw=true"))

# ╔═╡ 2d433e1c-97ca-4795-90e0-a7f398e1aab6
let
	sq_hani = channelview(hani) .|> (x -> x^2) |> colorview(RGB)
	[hani' sq_hani']
end

# ╔═╡ 695cbd82-2de8-456d-bb0b-72f3ad01501e
html"""
<span style="font-size:8px;color:grey;"><s>귀엽단 것을 알 수 있다.</s></span>
"""

# ╔═╡ 723edd99-5e63-477f-bc64-70ebb9c3417e
md"""
> 색상이 어두워졌다.
"""
...
manifest_format = "2.0"
project_hash = "85f15ec46071067f0d04dfcbd05b8e41c885d7eb"
