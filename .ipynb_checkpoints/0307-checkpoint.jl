...
# ╔═╡ 126969b7-1dad-41c8-986f-abdf96c5fce0
md"""
\sqrt or sqrt(x^2+y^2)
...
# ╔═╡ d0d2e5b7-522d-4297-b95c-571f1ff54cb7
md"""
람다 문법과 유사한 이용이 가능
"""

# ╔═╡ 2cda549a-ea90-4d6e-a966-237f12614f3f
g = (x -> 2x)  ## 파이썬에서 (lambda x : 2x)를 g라는 함수로 정의한 것과 동일
...
function h(x)
	return ℯ^x / (1+ ℯ^x)  ## 시그모이드 함수(?) def 대신 function을 써야 한다
end

# ╔═╡ 37a3cb1b-3dbc-4da4-92c8-0dcf53af52bc
md"""
h = (x -> ℯ^x/(1+ℯ^x)) 이것과 동일하다
"""

# ╔═╡ ae127a52-033e-47ba-a2eb-8e2b35ae1ec0
h(3)

# ╔═╡ a7fa4096-bdec-4979-8c93-c5cd11bedaf8
plot(h)
...
a = @bind a Slider(-5:0.01:5,show_value=true) ## a에 Slider의 값을 bind하겠다.
...
# ╔═╡ dd5e5710-e7dd-4ad4-b7c4-d2871dfe6ae3
let
	l = (x -> a*x+b)
	h = (x -> ℯ^x/(1+ℯ^x))
	plot(h∘l, -20, 20)
...
# ╔═╡ c5b507a6-2058-49cf-b826-9889b2e4f287
md"""
예시 1 : 벡터 + 벡터
"""
...
# ╔═╡ edac8836-e18f-4c85-993b-e30c871047f4
md"""
예시2 : 벡터 + 스칼라
"""

# ╔═╡ c8416fc8-2a59-45cd-a929-ed4dac57d43c
[1,2,3] .+ 1  ## 원소별로 각각 연산(함수)을 행하라

# ╔═╡ d697c938-e589-4fdd-8f7d-67de81b235e8
md"""
> R처럼 더하기하면 그냥 되게 해주면 안되냐???
"""

# ╔═╡ ac1e7e15-cd86-4470-8445-36e356cfd08f
@. [1,2,3] + 1

# ╔═╡ 7f8dede6-4643-4186-a4f6-58e4f80211e5
md"""
예시3 : 스칼라 -> 스칼라
"""

# ╔═╡ d64d572c-c9c6-4116-90e8-f9fa4cfa8273
[1, 2, 3] .|> (x -> x^2) .|> (x -> x-1)  ## 어떻게 연산하는지 명시해줘야 작동함

# ╔═╡ eadfac03-bc4f-4bcc-9b27-a57692ef3945
md"""
예시4 : 벡터 -> 스칼라
"""

# ╔═╡ 134ecfc1-abf4-45a0-a17b-9b444b464529
(@. [1,2,3] |> (x -> x^2)) |> mean  ## .찍기 귀찮을 때... + 일부만 브로드캐스팅 할 때(mean 함수는 개별 적용하면 안되니까)

# ╔═╡ 8e763dc7-5655-4b90-9579-81b1f6e008a8
md"""
예시5 : 스칼라 -> 벡터
"""

# ╔═╡ 9ec297ca-0d77-48fd-b844-9d6cf8b69cf7
let
...
# ╔═╡ 487ad75c-c1de-4877-944d-5578805c764e
function pdf(x, y)
	x = (x-μ₁)/σ₁  ## 표준화
	y = (y-μ₂)/σ₂
	c1 = 2π*σ₁*σ₂*√(1-ρ^2)  ## 기타 수식
	c2 = 2(1-ρ^2)
	return 1/c1
...
# ╔═╡ b52bfb6e-8152-4423-8c6e-21bcb0b3b0d9
md"""
f스트링인데, 안에다 함수나 인스턴스를 넣어도 그대로 작동하는듯, 개쩜
"""
