...
# ╔═╡ adaa75c2-d151-4141-aeb5-58775dd22fe5
let
...
# ╔═╡ 5e52b88b-2f29-4d08-ac17-0aa1e8fdd3c6
let
	B, W, R = RGB(0, 0, 1), RGB(1, 1, 1), RGB(1, 0, 0)
	j = ones(4)
	France = j*[B B W W R R]  ## 정보의 용량이 줄어듦
end
...
# ╔═╡ d0391041-b8cf-4abf-baf0-e7e26db7c456
md"""
> 30.56%의 숫자만 써도 표현할 수 있었다...
"""
...
# ╔═╡ fb4bc505-b4a4-40dc-92df-987e2baa203b
let
	## channel view
	j = ones(4)
	r = [0 0 1 1 1 1]
...
# ╔═╡ e81b8f7a-16a4-4a04-ad8b-4612712753cf
let
	## channel view
	j = ones(4)
	r = [0 0 1 1 1 1]
	...
	[stack([R, G, B], dims = 1)[i,:,:] for i in 1:3]
end
...
# ╔═╡ d0fc92bc-8789-4ce8-ae70-836cc6457638
md"""
> stack of 9 × 13 vectors
"""
...
# ╔═╡ 6ef6399f-9adb-4a1e-b7b5-9d567f09cadd
md"""
> 스칼라 연산하듯 벡터의 외적의 합으로 나타낼 수 있다.
"""
...
# ╔═╡ d84888ba-839f-4781-81d3-e1f7ed97f213
let
	A1 = [1, 2]
	A2 = [2, 3]
	A = [A1 A2]
...
# ╔═╡ ed618e39-8ea2-48f1-bf8d-e0594dfe652c
md"""
> 그냥 그렇게 쓰도록 하자!
"""
...
# ╔═╡ 57fcb10e-dd6b-4784-8135-77ba8acdbe71
md"""
> 대충 분할행렬
"""

# ╔═╡ 327134a2-5ea3-4955-9cbc-71a606ca2646
let
...
# ╔═╡ 2369057d-332f-4748-af82-9be5c9f0dc33
md"""
> n > p일 때, U는 열이 정직교하고 UᵀU = I

> n < p일 때, Vᵀ는 행이 정직교하고 VᵀV = I
"""
...
# ╔═╡ 1c7e0d52-23d9-453f-9b53-cab24c735ac0
U * Diagonal(d) * V'  ## recontruction
...
# ╔═╡ d62e9ccb-0518-4e9c-9755-b2d05dbe61d2
md"""
> V는 직교행렬이다.
"""
...
md"""
> $$U = [U_1 U_2 \cdots U_m], ~ UD = [d_1U_1 d_2U_2 \cdots d_mU_m]$$
>
> $$X = U_1d_1V_1^T + \cdots + U_md_mV_m^T$$
"""
